...
const Portfolio = () => {
  return (
    <>
      <section className={`${styles.Portfolio} top`} id='portfolio'>
        <div className='container'>
          ...
          <div className='content grid'>
            ...
            {/*<div className='box btn_shadow '>
              <div className='img'>
                  <img src='https://rainbowit.net/html/inbio/assets/images/portfolio/portfolio-01.jpg' alt="" width="300" height="300" />
              </div>
